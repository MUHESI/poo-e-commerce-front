...
import But from "../widgets/Button";
        ...
        {tutorialSteps.map((step, index) => (
          <div key={step.label}>
            {Math.abs(activeStep - index) <= 2 ? (
              <img className={classes.img} src={step.imgPath} alt='cool' />
            ) : null}
          </div>
        ))}
      </AutoPlaySwipeableViews>
      ...
      <div className='container'>
        <div className='container-Profile'>
          ...
          <div className='content-body'>
            ...
            <div className='bio'>
              <p>{substringText(paragrah, 150)}</p>
            </div>
          </div>

          {/* <hr /> */}
          <div className='content-actions margin-bottom-2'>
            <span>&#10029;</span>
            <span>&#10029;</span>
            <span>&#10029;</span>
            {/* <span>&#10030;</span> */}
