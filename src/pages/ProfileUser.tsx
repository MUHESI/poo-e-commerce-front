...
import ResponsiveDialog from "../components/widgets/ResponsiveDialogue";
...
const ProfileUser = () => {
  return (
    <div className="mainProfileUser padding-2">
          ...
          <div className="content-body">
            ...
            <div className="bio">
              <p>
                ...
                I love Rick Owens’ bed design but the back is.. Kanye loves
